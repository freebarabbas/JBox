...
public class JBoxHtmlLayout extends HTMLLayout {
	...
	public String getHeader() {
		...
		sbuf.append("<title>Running Message</title>" + Layout.LINE_SEP);
		sbuf.append("<style type=\"text/css\">" + Layout.LINE_SEP);
		sbuf.append("<!--" + Layout.LINE_SEP);
		sbuf.append("body, table {font-family: verdana; font-size: small;}"
				+ Layout.LINE_SEP);
		...
		sbuf.append("<th width=10%>Thread</th>" + Layout.LINE_SEP);
		sbuf.append("<th width=8%>Level</th>" + Layout.LINE_SEP);
		sbuf.append("<th width=8%>Category</th>" + Layout.LINE_SEP);
		if (locationInfo) {
