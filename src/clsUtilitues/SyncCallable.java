...
public class SyncCallable implements Callable<Boolean>  {
	...
	public SyncCallable(List<String> p_syncfolders,String p_metafile,String p_url,String p_storageurl,String p_username,String p_tkn,ebProxy p_pxy,int p_mod, long p_synctime, String p_containername)
	{
		m_syncfolders=p_syncfolders;
		m_metafile=p_metafile;
		m_url=p_url;
