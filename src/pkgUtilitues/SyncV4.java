...
import pkgCompExtract.ZipProcess;
import pkgRESTConnector.*;
import pkgTypes.*;

public class SyncV4 implements Runnable {
	...
	public SyncV4(List<String> p_syncfolders,String p_metafile, String p_url,String p_username,String p_pwd,ebProxy p_pxy,int p_mod)
	{
	...
	public SyncV4(List<String> p_syncfolders,String p_metafile,String p_url, String p_storageurl,String p_username,String p_tkn,ebProxy p_pxy,int p_mod)
	{
		m_syncfolders=p_syncfolders;
		m_metafile=p_metafile;
		m_url=p_url;
